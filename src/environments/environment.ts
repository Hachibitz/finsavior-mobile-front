...
export const BILLS_SERVICE_BATCH_REGISTER = URL_BASE_DEV + BILL_SERVICE + '/batch-register';
...
export const AI_TRANSCRIPTION_SERVICE = URL_BASE_DEV + '/ai/transcription';
...
export const AI_DOCUMENT_SERVICE = URL_BASE_DEV + '/ai/document';
